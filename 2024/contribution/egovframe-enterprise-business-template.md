...
- [[메뉴생성관리] 롬복 생성자 기반 종속성 주입](#메뉴생성관리-롬복-생성자-기반-종속성-주입)
...
브랜치 생성
```
2024/di/EgovMenuCreateManageController
```
...
[2024년 전자정부 표준프레임워크 컨트리뷰션][템플릿 프로젝트 내부업무 시스템][메뉴생성관리] 롬복 생성자 기반 종속성 주입

https://github.com/LeeBaekHaeng/egovframe-enterprise-business-template/commits/2024/di/EgovMenuCreateManageController/

https://github.com/eGovFramework/egovframe-enterprise-business-template/pull/43

https://youtu.be/T9MXTywL8Ww

### [메뉴목록관리] 롬복 생성자 기반 종속성 주입
...
크롬 링크 주소 복사
```
http://localhost:8080/ebt_webapp/sym/mnu/mpm/EgovMenuManageSelect.do
```
...
브랜치 생성
```
2024/di/EgovMenuManageController
```
...
//	private MenuManageDAO menuManageDAO;
	private final MenuManageDAO menuManageDAO;
...
//	private final CommonsMultipartResolver mailmultipartResolver;
```
...
[2024년 전자정부 표준프레임워크 컨트리뷰션][템플릿 프로젝트 내부업무 시스템][메뉴목록관리] 롬복 생성자 기반 종속성 주입

https://github.com/LeeBaekHaeng/egovframe-enterprise-business-template/commits/2024/di/EgovMenuManageController/

https://github.com/eGovFramework/egovframe-enterprise-business-template/pull/44

https://youtu.be/fNU0Hz9Bl98

### [분류코드관리] 롬복 생성자 기반 종속성 주입
...
크롬 링크 주소 복사
```
http://localhost:8080/ebt_webapp/sym/ccm/ccc/EgovCcmCmmnClCodeList.do
```
...
브랜치 생성
```
2024/di/EgovCcmCmmnClCodeManageController
```
...
[2024년 전자정부 표준프레임워크 컨트리뷰션][템플릿 프로젝트 내부업무 시스템][분류코드관리] 롬복 생성자 기반 종속성 주입

https://github.com/LeeBaekHaeng/egovframe-enterprise-business-template/commits/2024/di/EgovCcmCmmnClCodeManageController/

https://github.com/eGovFramework/egovframe-enterprise-business-template/pull/45

https://youtu.be/YnTOa8fll0A

### [공통코드관리] 롬복 생성자 기반 종속성 주입
...
크롬 링크 주소 복사
```
http://localhost:8080/ebt_webapp/sym/ccm/cca/EgovCcmCmmnCodeList.do
```
...
브랜치 생성
```
2024/di/EgovCcmCmmnCodeManageController
```
...
[2024년 전자정부 표준프레임워크 컨트리뷰션][템플릿 프로젝트 내부업무 시스템][공통코드관리] 롬복 생성자 기반 종속성 주입

https://github.com/LeeBaekHaeng/egovframe-enterprise-business-template/commits/2024/di/EgovCcmCmmnCodeManageController/
...
크롬 링크 주소 복사
```
http://localhost:8080/ebt_webapp/sym/ccm/zip/EgovCcmZipList.do
```

검색
```
/sym/ccm/zip/EgovCcmZipList.do
```

브랜치 생성
```
2024/di/EgovCcmZipManageController
```
...
[2024년 전자정부 표준프레임워크 컨트리뷰션][템플릿 프로젝트 내부업무 시스템][우편번호관리] 롬복 생성자 기반 종속성 주입

https://github.com/LeeBaekHaeng/egovframe-enterprise-business-template/commits/2024/di/EgovCcmZipManageController/

https://github.com/eGovFramework/egovframe-enterprise-business-template/pull/48

https://youtu.be/SKmzaV3cZ1E
...
크롬 링크 주소 복사
```
http://localhost:8080/ebt_webapp/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_AAAAAAAAAAAA
```
...
[2024년 전자정부 표준프레임워크 컨트리뷰션][템플릿 프로젝트 내부업무 시스템][공지사항] 롬복 생성자 기반 종속성 주입

https://github.com/LeeBaekHaeng/egovframe-enterprise-business-template/commits/2024/di/EgovBBSManageController/
