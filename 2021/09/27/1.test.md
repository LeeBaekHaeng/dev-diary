...
/egovframe-common-components/src/main/java/egovframework/com/cmm/EgovComponentChecker.java
	...
	*/
	public static boolean hasComponent(String componentName){
		...
		try{
			...
			return false;
		}catch(Exception ex){// 해당 컴포넌트를 찾을 수없을 경우 false반환
			return false;
		}
	}
```
...
- https://github.com/LeeBaekHaeng/egovframe-common-components/commit/176f4cee30981728b622141c50d767e6413cdb5a
- https://youtu.be/hPMq7c8VjO4
