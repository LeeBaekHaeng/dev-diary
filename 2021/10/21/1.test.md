# EgovArticleCommentDAOTest_deleteArticleComment 단위 테스트

```
2. EgovArticleCommentDAOTest_selectArticleCommentList
3. EgovArticleCommentDAOTest_selectArticleCommentListCnt
1. EgovArticleCommentDAOTest_insertArticleComment
*6. EgovArticleCommentDAOTest_deleteArticleComment
4. EgovArticleCommentDAOTest_selectArticleCommentDetail
5. EgovArticleCommentDAOTest_updateArticleComment
```

/egovframe-common-components/src/test/java/egovframework/com/cop/bbs/service/impl/EgovArticleCommentDAOTest_deleteArticleComment.java
...
- https://github.com/LeeBaekHaeng/egovframe-common-components/commit/e29fb9446ca293eb231e7a637fbd3a8d8756fcda
- https://youtu.be/VOaPPitQxm4
