# EgovBBSMasterServiceImplTest_updateBBSMasterInf 단위 테스트
...
/egovframe-common-components/src/test/java/egovframework/com/cop/bbs/service/impl/EgovBBSMasterServiceImplTest_updateBBSMasterInf.java
...
```sql
select * from comtccmmndetailcode where code_id = 'COM101'
;
```

- https://github.com/LeeBaekHaeng/egovframe-common-components/commit/a752c446cd09baa3206590608cfe635361253d3b
- https://youtu.be/-5U43pI9C_w
